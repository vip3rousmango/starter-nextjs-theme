...
const Footer = defineNestedType(() => ({
    ...
    fields: {
        ...
        socialLinks: {
            ...
            of: [Social],
            default: [
                { type: 'facebook', icon: 'facebook', label: '', altText: 'facebook', url: '/', elementId: false, showIcon: true },
                { type: 'twitter', icon: 'twitter', label: '', altText: 'twitter', url: '/', elementId: false, showIcon: true }
            ]
        },
        legalLinks: {
            type: 'list',
